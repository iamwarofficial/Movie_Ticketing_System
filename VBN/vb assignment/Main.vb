...
Public Class Main
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If MessageBox.Show("Are you sure", "Delete Booking", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) Then
    ...
    Private Sub PayableAmountLabel_Click(sender As Object, e As EventArgs)
